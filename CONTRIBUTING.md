...
Home Suite is beta software and a daily driver in its original deployment.
Changes should preserve predictable command execution and keep PTT, wakeword,
text, and companion-client behavior isolated where their hardware or timing
policies differ.
