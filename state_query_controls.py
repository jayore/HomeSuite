# Auto-generated by patch_replace_state_query_controls_v2.py
# Purpose: answer device state questions (on/off, locked/unlocked, all lights, temperature)
...
def handle_state_query_controls(
    ...
    *,
    ...
    """
    Returns a spoken response string if this is a state query, else None.
    """
    t = _norm(text)
