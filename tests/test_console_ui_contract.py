...
class ConsoleUiContractTests(unittest.TestCase):
    ...
    def test_navigation_separates_system_device_and_tools(self):
        ...
        self.assertIn('<span>System Health</span>', html)
        self.assertIn('data-title="System Health"', html)
        self.assertIn('<h1>System Health</h1><p>Readiness checks and troubleshooting</p>', html)
        self.assertNotIn('<span>Diagnostics</span>', html)
        self.assertIn('Open System Health', javascript)
